                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center justify-center w-full">
                                    <label class="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed rounded-xl cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors duration-200"
                                        :class="formErrors.photo ? 'border-red-500' : 'border-gray-300'">
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6" x-show="!photoPreview">
                                            <svg class="w-12 h-12 mb-3" :class="formErrors.photo ? 'text-red-400' : 'text-gray-400'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                            </svg>
                                            <p class="mb-2 text-sm" :class="formErrors.photo ? 'text-red-500' : 'text-gray-500'"><span class="font-semibold">Upload photo</span></p>
                                            <p class="text-xs" :class="formErrors.photo ? 'text-red-500' : 'text-gray-500'">PNG, JPG or JPEG (MAX. 2MB)</p>
                                        </div>
                                        ...
                                        <input type="file" id="photo-upload" class="opacity-0 absolute" name="photo" accept="image/*" required
                                            x-on:change="
                                ...
                                <p class="mt-1 text-sm text-red-600" x-show="formErrors.photo" x-text="formErrors.photo"></p>
                                @error('photo')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        class="w-full px-4 py-3 rounded-xl border transition duration-200"
                                        :class="formErrors.password ? 'border-red-500' : 'border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500'"
                                        id="password"
                                        name="password"
                                        required
                                    >
                                    ...
                                    >
                                        <svg x-show="!showPassword" class="h-5 w-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <p class="mt-1 text-sm text-red-600" x-show="formErrors.password" x-text="formErrors.password"></p>
                                @error('password')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input
                                        ...
                                        class="w-full px-4 py-3 rounded-xl border transition duration-200"
                                        :class="formErrors.password_confirmation ? 'border-red-500' : 'border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500'"
